      ...
      <div class="modal-header">
        ...
        <form action="code.php" method="post" enctype="multipart/form-data">
          ...
          <div class="modal-footer">
            ...
            <button type="submit" name="addagent" class="btn btn-primary">Save</button>
          </div>
        </form>
      </div>
    </div>
    ...
    <div class="col-md-12">
      ...
      <div class="card">
        <div class="card-header">
          <h3 class="card-title">Agents
          </h3>
          <a href="#" data-toggle="modal" data-target="#addusermodal" class="btn btn-primary btn-sm float-right"> Add Agent </a>
        </div>
  <!-- /.card-header -->
          <div class="card-body">
            <table id="example1" class="table table-bordered table-striped">
              ...
              <tbody>
                ...
                <tr>
                  ...
                  <td>
                    <a href="agents-edit.php?user_id=<?php echo $row['id'];?>" class="btn btn-info btn-sm">Edit</a>
